...
5087 个单测全过 / TypeScript 严格模式 / MIT 开源.
...
> v12.370.1 · 5087 单测全过 · 0 API key 强制依赖.
...
> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · open source · 5087 tests passing.
