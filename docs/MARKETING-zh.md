...
- **Veo 3.1 / Kling 3.0 / Seedance 2.0** 画质、跨镜一致、甚至原生多镜 + 原生音频都已第一梯队 — 但都不烧中文字幕、不能自托管、不开源、没多人协作时间线.
- **HappyHorse-1.0(阿里)** arena T2V/I2V 双榜第一、音画联合生成,API 已商用(百炼/fal)— 但同样不烧中文字幕、不开源、单段为主;多镜可控管线仍得自己接.(Sora 2 已宣布 2026 年内停服,移出对比)
- **Runway Gen-4.5** 工业级控制 (运动笔刷 / 参考一致), 但中文适配弱 + 闭源 + 无字幕烧入.
- 共同缺口 (= Wind Comic 的护城河): 真·中文字幕烧入 · 竖屏短剧套路 · 自托管 · 自带 LLM · 开源 · 实时协作 · 节奏审计.
