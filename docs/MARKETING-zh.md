...
- **Sora 2** 给你 5 秒一段连续镜头. 想拍 6 镜短剧 — 自己接吧.
- **Kling 2.0** 出图质量高, 但 6 镜跑下来角色变脸 + 画风跳脱.
- **Vidu Q3** 长镜头不错, 但中文字幕一律乱码.
- **Higgsfield Cinema Studio** 完整流水线但闭源 + 月费 $30+.
- **Runway Gen-4** 工业级, 但中文场景适配差.
