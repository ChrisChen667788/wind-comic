...
6010 个单测全过 / TypeScript 严格模式 / MIT 开源.
...
8 个月, v2.0 → v12.453.1.1.1, 6010 个单测, MIT 开源. 这就是 **Wind Comic**.
...
> v12.370.1 · 6010 单测全过 · 0 API key 强制依赖.
...
> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · open source · 6010 tests passing.
