...
5294 个单测全过 / TypeScript 严格模式 / MIT 开源.
...
8 个月, v2.0 → v12.416.1.1.1, 5294 个单测, MIT 开源. 这就是 **Wind Comic**.
...
> v12.370.1 · 5294 单测全过 · 0 API key 强制依赖.
...
> One sentence → finished short drama. Multi-agent AI pipeline · cinematic storyboards · real-time collab timeline · BYO LLM · open source · 5294 tests passing.
