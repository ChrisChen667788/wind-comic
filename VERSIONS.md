...
| **v8.3 P6.2** | 2026-05-31 | `(本次)` | 阶段十 P6.2 · v8 观感截图刷新:新 `scripts/capture-v8.mjs`(puppeteer 登录 demo → 捕获)生成 `assets/v8/dashboard-bento.png`(非对称 bento 总览)/ `style-gallery.png`(60 张 AI 缩略图填满)/ `template-icons.png`(18 枚 AI 金色霓虹题材图标);README.md / README.zh-CN.md 顶部加「🎨 v8.3 精品化设计」展示块(2 图表格 + 全宽模板图标)+ docs/modelscope-profile.md 同步 |
