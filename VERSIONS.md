...
> 多智能体 AI 短剧/漫剧生成流水线。本文件汇总从首个公开版本 (v2.12.0) 到当前 (**v12.347**)
> 的全部版本信息。每条含发布日期 + commit + 关键交付。详细验收数据见 `ROADMAP.md`。
>
> 截至 **v12.347**:**vitest 4488 全绿,tsc 0 错误**(SQLite/Postgres 双驱动)。v12.218 起进入「加固路线图」(对抗尽调 P0→收官,详见 `docs/ROADMAP-hardening-v12.218.md`)。
>
...
| **v12.347.0** | 2026-08-28 | `待填` | **🏷 `persistent_url` 里存着会过期的外链 —— 这一列的名字就是它的承诺**。
